                    ...
                    <div class="dropdown">
                        <div class="btn-group mb-0">
                            ...
                            <div class="dropdown-content">
                              <a href="' . route('admin.notices.edit', [$row->id]) . '"><i class="fa fa-edit" aria-hidden="true"></i> ' . trans('app.edit') . '</a>                             
        ...
        return $this->builder()
            ...
            ->parameters([
                ...
                'fnDrawCallback' => 'function( oSettings ) {
                    ...
                    $(\'#status, #notice-board-table_wrapper select\').select2({minimumResultsForSearch: -1});
                }',
            ])
