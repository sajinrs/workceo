    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($purpose)
            ->addColumn('action', function ($row) {
                ...
                $action .= '<a href="javascript:;"  class="btn btn-outline-info btn-circle sa-params-edit" 
                      data-toggle="tooltip" data-user-id="' . $row->id . '" data-original-title="Edit"><span class="icon-pencil" aria-hidden="true"></span></a>';


                $action .= ' <a href="javascript:;" class="btn btn-outline-danger  btn-circle
                sa-params"
                      data-toggle="tooltip" data-user-id="' . $row->id . '" data-original-title="Delete"><span class="icon-trash" aria-hidden="true"></span></a>';
                return $action;
            })
            ->editColumn(
                'created_at',
