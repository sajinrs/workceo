...
class IncomeVsExpenseReportController extends AdminBaseController
{
    ...
    public function getGraphData($fromDate, $toDate)
    {
        ...
        $fromDate = Carbon::createFromFormat($this->global->date_format, $fromDate)->format('Y-m-d');
        $toDate   = Carbon::createFromFormat($this->global->date_format, $toDate)->format('Y-m-d');
