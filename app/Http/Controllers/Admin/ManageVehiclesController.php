...
class ManageVehiclesController extends AdminBaseController
{
    ...
    {
        $this->vechicleCount = Vehicle::count();
        $this->vehicleNotAssigned = Vehicle::where('operator_id', NULL)->count();
        $this->employees = User::allEmployees();
        //$this->departments = Team::all();        
        return $dataTable->render('admin.vehicles.index', $this->data);
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        //return Reply::redirect(route('admin.vehicles.index'), __('messages.vehicleAdded'));
    }
    ...
    public function edit($id)
    {
        ...
        if($this->vehicle->operator_id)
        {
            ...
            $this->user['roleName'] = 'vehicle_operator';
        }
    ...
    {       
        ...
        return Reply::success(__('messages.vehicleDeletedSuccessfully'));        
    }
