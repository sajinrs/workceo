        ...
        return DataTables::of($lead)
            ->addColumn('action', function ($row) {
                ...
                if ($row->status == 'waiting') {
                    $convert = '<a href="' . route("admin.proposals.convert-proposal", $row->id) . '" ><i class="fa fa-file"></i> Convert Invoice </a>';
                }
                return '
                <div class="dropdown-basic">
                    <div class="dropdown">
                        <div class="btn-group mb-0">
                          ...
                          <a href="' . route("admin.proposals.download", $row->id) . '" ><i class="fa fa-download"></i> ' . __('modules.proposal.download') . '</a>
                 <a href="' . route("admin.proposals.edit", $row->id) . '" ><i class="fa fa-edit"></i> ' . __('modules.proposal.edit') . ' </a>
                  ' . $convert . '
                 <a class="sa-params" href="javascript:;" data-proposal-id="' . $row->id . '"><i class="fa fa-times"></i> ' . __('modules.proposal.delete') . ' </a>
