...
class ApiAdminBaseController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(function ($request, $next) {
            $this->global = $this->company = Company::with('currency', 'package')->withoutGlobalScope('active')->where('id', auth('api')->user()->company_id)->first();
            ...
            try {
                ...
                if (!$this->gdpr) {
                    ...
                    $gdpr->company_id = auth('api')->user()->company_id;
                    $gdpr->save();
    ...
    public function logVehicleActivity($vehicleID, $text)
    {
        $activity = new VehicleActivity();
        $activity->vehicle_id = $vehicleID;
        $activity->activity = $text;
        $activity->save();
    }
