...
class ApiAdminManageEstimatesController extends ApiAdminBaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->pageTitle = 'app.menu.estimates';
        $this->pageIcon = 'fas fa-coins';
    ...
    {
        return ApiResource::collection(Estimate::paginate(10));
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = Estimate::findOrFail($estimate->id);

        $response = [
            'success' => 1,
            "message" => __('messages.estimateUpdated'),
            'data'    => $result
        ];

        return new ApiResource($response);

        //return response()->json([ 'success' => 1, "message" => __('messages.estimateCreated'), 'data' => $response]);
...
//        $data['clients'] = ClientDetails::all();
...
//        $data['categories'] = ProductCategory::all();
    ...
    public function destroy($id)
    {
        ...
        $response = [
            'success' => 1,
            "message" => __('messages.estimateDeleted'),
        ];
        return new ApiResource($response);
        //return response()->json([ 'success' => 1, "message" => __('messages.estimateDeleted')]);
