...
class ApiAdminManageTicketsController extends ApiAdminBaseController
{
    public function __construct()
    {
        parent::__construct();
        $this->pageTitle = 'app.menu.tickets';
        $this->pageIcon = 'fas fa-paperclip';
    ...
    {
        return ApiResource::collection(Ticket::paginate(10));
    }
    ...
    public function store(Request $request)
    {
        ...
        $result = Ticket::findOrFail($ticket->id);
        $response = [
            'success' => 1,
            "message" => __('messages.ticketAddSuccess'),
            'data'    => $result
        ];

        return new ApiResource($response);

        //return response()->json([ 'success' => 1, "message" => __('messages.ticketAddSuccess')]);
    ...
    public function show($id)
    {
        ...
        /* $data['groups'] = TicketGroup::all();
        $data['types'] = TicketType::all();
        $data['channels'] = TicketChannel::all();
        $data['templates'] = TicketReplyTemplate::all(); */
    ...
    public function update(Request $request, $id)
    {
        ...
        //return response()->json([ 'success' => 1, "message" => __('messages.updateSuccess')]);
    }
    ...
    public function destroy($id)
    {
        ...
        $response = [
            'success' => 1,
            "message" => __('messages.ticketDeleteSuccess'),
        ];

        return new ApiResource($response);
        //return response()->json([ 'success' => 1, "message" => __('messages.ticketDeleteSuccess')]);
    }
