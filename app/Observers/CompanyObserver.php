...
class CompanyObserver
{
    ...
    public function addDashboardWidget($company)
    {
        ...
        \App\DashboardWidget::create([
            'widget_name' => 'user_action_menu_bar',
            'status' => 0,
            'company_id' => $company->id,
            'sort_order' => 1
        ]);
    ...
    public function addLeadSourceAndLeadStatus($company)
    {
        ...
        $status = [
           /*  ['type' => 'pending', 'company_id' => $company->id],
            ...
            ['type' => 'raw', 'company_id' => $company->id],
            ['type' => 'assigned', 'company_id' => $company->id],
            ['type' => 'working', 'company_id' => $company->id],
            ['type' => 'qualified', 'company_id' => $company->id],
            ['type' => 'nurture', 'company_id' => $company->id],
            ['type' => 'unqualified', 'company_id' => $company->id]
        ];
