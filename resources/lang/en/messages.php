...
return array(
  ...
  'newFileUploadedToTheProject' => 'New file uploaded to the job.',
  'newTaskAddedToTheProject' => 'New task added to the job.',
  'newMemberAddedToTheProject' => 'New member added to the job.',
  'addedAsNewProject' => 'added as new job.',
  ...
  'clientUploadedAFileToTheProject' => '(Client) uploaded a file to the job.',
  'fileUploadedSuccessfully' => 'File uploaded successfully.',
  'isAddedAsProjectMember' => 'is added as job member.',
  'memberRemovedFromProject' => 'Member removed from job successfully.',
  'noProjectFound' => 'No Job Found.',
  'noProjectAssigned' => 'No job assigned to you.',
  'noActivityByThisUser' => 'No activity by the user.',
  'timerStartedProject' => 'Started the timer for job ',
  'nopaymentFound' => 'No Payment Found.',
  'noestimateFound' => 'No Estimate Found.',
  'nocontractsFound' => 'No Contracts Found.',
  'updatedProfile' => 'Updated profile.',
  'taskUpdated' => 'Marked the task as ',
  'noProjectCategoryAdded' => 'No job category added.',
  'noClientAdded' => 'No client added.',
  'ClientAdded' => 'Client added.',
  'noActiveTimer' => 'No active timer.',
  'noMemberAddedToProject' => 'No member added to this job.',
  ...
  'projectUpdated' => 'Job updated successfully.',
  'projectDeleted' => 'Job deleted successfully.',
  ...
  'templateMemberRemovedFromProject' => 'Template Member removed from job successfully.',
  'noProjectTemplateAdded' => 'No job template added.',
  ...
  'operatorUpdated' => 'Operator updated successfully.',
  ...
  'noProjectCategory' => 'No job category found.',
  ...
  'noClientAddedToProject' => 'No client assigned to the job.',
...
After that upload the favicons to public/favicon directory.',
  ...
  'noTaskAddedToProject' => 'No task added to this job.',
  ...
  'noTaskCategoryAdded' => 'No task category added.',
    'noprojectActivityTimeline' => 'No Job Activity Timeline.',
    'projectArchiveSuccessfully' => 'Job archived successfully.',
  'projectRevertSuccessfully' => 'Job reverted successfully.',
  'archiveMessage' => 'Do you want to archive this job.',
  'confirmArchive' => 'Yes, archive it!',
  'confirmRevert' => 'Yes, revert it!',
  'confirmNoArchive' => 'No, cancel please!',
  'sweetAlertTitle' => 'Are you sure?',
  'unArchiveMessage' => 'Do you want to revert this job.',
