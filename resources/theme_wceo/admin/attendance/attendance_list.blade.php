        ...
        <div class="card-header">
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-xs-6">
                    {{ ucwords($row->name) }} <br>
                    <span class="text-muted">{{ ucfirst($row->designation_name) }}</span>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-body ">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="clock_in_ip" id="clock-in-ip-{{ $row->id }}" class="form-control" value="{{ $row->clock_in_ip ?? request()->ip() }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label class="switch">
                                            <input type="checkbox" @if($row->late == "yes") checked @endif id="late-{{ $row->id }}"><span class="switch-state"></span>
                                        </label>                                            
                                    </div>
                                </div>
                            ...
                            <div class="row m-t-15">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label" >@lang('modules.attendance.halfDay')</label> <br />
                                        <label class="switch">
                                            <input type="checkbox"@if($row->half_day == "yes") checked @endif id="halfday-{{ $row->id }}"><span class="switch-state"></span>
                                        </label>                                            
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <button type="button" class="btn btn-primary text-white save-attendance" data-user-id="{{ $row->id }}"> @lang('app.save')</button>
                                    </div>
                                </div>
