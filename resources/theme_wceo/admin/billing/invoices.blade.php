...
@section('content')
    ...
    <div class="container-fluid">
        <div class="page-header p-t-0">
            <div class="card">
                <div class="card-header"> <h5>@lang('app.menu.invoices')</h5> </div>
                <div class="card-body">
                    <div class="row">
    ...
    <script>
        ...
        $(function() {
            var table = $('#users-table').dataTable({
                ...
                stateSave: true,
                "ordering": false,
                ajax: '{!! route('admin.billing.invoice_data') !!}',
                language: {
                ...
                columns: [
                    { data: 'due_date', name: 'id' ,bSort: false },
        ...
        $(document).ready(function(){
            $('#users-table_wrapper select').select2({minimumResultsForSearch: -1});
        });
