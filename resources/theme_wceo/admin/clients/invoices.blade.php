            ...
            <div class="row product-page-main">
                <div class="col-sm-12">
                    <ul class="showProjectTabs nav nav-tabs border-tab mb-0" id="top-tab" role="tablist">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="{{ route('admin.clients.invoices', $client->client_details->user_id) }}"><span>@lang('app.menu.invoices')</span></a></li>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="4"> No invoice for this client.</td>
                                            </tr>
                                        @endforelse
                                        </tbody>
                                    </table>
