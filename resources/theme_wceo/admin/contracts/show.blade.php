                ...
                <div class="col-md-12" id="estimates">
                    <div class="row m-b-20">
                        <div class="col-md-12">
                            ...
                            <a class="btn btn-secondary m-b-10" href="{{ route("admin.contracts.index") }}"> <i class="fa fa-long-arrow-left"></i> Back To Contracts</a>
                            <a  class="btn btn-primary pull-right m-r-10" href="{{ route("admin.contracts.edit", $contract->id) }}"> @lang('app.edit')</a>
                            ...
                            <a href="{{ route("admin.contracts.download", $contract->id) }}" class="btn btn-secondary pull-right m-r-10"><i class="fa fa-file-pdf"></i> @lang('app.download')</a>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="card">
                    ...
                    <div class="row">
                                            ...
                                            <li id="discussion-row-{{$discussion->id}}">
                                                <div class="media">
                                                    <div class="media-body">
                                                        ...
                                                        <div class="row">
                                                        <div class="col-md-7">
                                                            <h6 class="mt-0 m-b-10">{{ $discussion->user->name }} -<span> 
                                                            {{ $discussion->created_at->timezone($global->timezone)->format($global->date_format.' '. $global->time_format) }}</span></h6>
                                                        </div>
                                                        <div class="col-md-5">
                        ...
                        <div class="col-md-4 p-l-30">
                            <div class="card overview p-20">
                                    ...
                                    <h5>@lang('modules.contracts.contractValue'): {{ $global->currency->currency_symbol }}{{ currencyFormat($contract->amount) }}</h5>
