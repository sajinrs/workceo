...
<div class="form-body">
                 ...
                 <div class="form-group">
                      ...
                      <input type="text" name="label" id="label" class="form-control " value="{{$custom_field->label}}">
                    ...
                    <div class="form-group">
                        ...
                        <input @if($custom_field->required === 'yes') checked @endif type="radio" name="required" id="optionsRadios1" value="yes" checked>
                        <label for="optionsRadios1"> @lang('app.yes') </label>


                        <input @if($custom_field->required === 'no') checked @endif type="radio" name="required" id="optionsRadios2" value="no" >
...
function removeBox(index){
    ...
    $('#save').click(function () {
        $.easyAjax({
            url: '{{route('admin.custom-fields.update', [$custom_field->id])}}',
