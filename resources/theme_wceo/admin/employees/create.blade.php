            ...
            <div class="col-sm-12">
                ...
                {!! Form::open(['id'=>'createEmployee','class'=>'ajax-form','method'=>'POST']) !!}
                    <div class="card-header">
                        <h4 class="card-title mb-0">@lang('modules.employees.createTitle')</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-label-group form-group">                                    
                                        <input type="text" name="employee_id" id="employee_id" class="form-control form-control-lg" placeholder="-" autocomplete="nope">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-label-group form-group">                                         
                                        <input autocomplete="nope" type="text" id="slack_username" name="slack_username" class="form-control form-control-lg" placeholder="-">
                                        <label for="slack_username" class="control-label">@ @lang('modules.employees.slackUsername')</label>
                                    </div>  
                                </div>  
                                <div class="col-md-6">
                                    <div class="form-label-group form-group">                               
                                        <input type="text" autocomplete="off"  name="joining_date" id="joining_date" class="form-control form-control-lg" placeholder="-">
                            ...
                            <div class="row">
                                <div class="col-md-6">                                 
                                    <div class="form-label-group form-group">
                                        <input type="text" autocomplete="off" name="last_date" id="end_date" class="form-control form-control-lg" placeholder="-">
                            ...
                            <div class="col-md-4 ">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <a href="javascript:;" id="addSkill" class="btn btn-sm btn-outline btn-block btn-secondary"><i
                            ...
                            <div class="row">
                                <div class="col-md-6">                                 
                                    <div class="form-label-group form-group">                                       
                                        <input type="text" name="hourly_rate" id="hourly_rate" class="form-control form-control-lg" placeholder="-">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-label-group form-group">   
                                      <textarea name="address"  id="address"  rows="5" class="form-control form-control-lg" placeholder="-"></textarea>   
...
<script>
    ...
    jQuery('#joining_date, #end_date').datepicker({
        autoclose: true,
        todayHighlight: true,
