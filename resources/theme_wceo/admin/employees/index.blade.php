            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="bookmark pull-right">
                        <a href="{{ route('admin.employees.create') }}" class="btn btn-primary btn-sm">@lang('modules.employees.addNewEmployee') <i data-feather="plus"></i> </a>
                    ...
                    <div class="card browser-widget bw-employee">
                        <div class="media card-body" style="padding: 10px">
                            <div class="media-body align-self-center count4 count_by_status">
                                ...
                                <div id="freeEmployees">
                                    <p>Employees Not Assigned To Job </p>
                                    <h4><span class="counter">{{ $freeEmployees }}</span></h4>
                                </div>
                                <div id="adminUser">
                                    <p>Admin User Role</p>
                                    <h4><span class="counter">{{ $adminUserCount }}</span></h4>
                                </div>
                                <div id="vehicleAssignedEmp">
                                    <p>Employees Assigned Vehicle </p>
                                    <h4><span class="counter">{{ count($vehicleEmpCount) }}</span></h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        @if($totalEmployees == 0)
                            <div class="col-md-12">
                                <div class="empty-content text-center">
                                    ...
                                    <a href="{{ route('admin.employees.create') }}" class="btn btn-primary btn-sm m-t-20">Add Employee</a>
                                </div>
                            </div>
                        @else
