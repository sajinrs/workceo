            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h4 class="card-title mb-0">@lang('modules.estimates.updateEstimate')</h4>
                    </div>
                    <div class="card-body">
                        <div class="form-body">
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div>
                                            <div class="input-group ">
                                                <div class="input-group-addon  form-control-lg f-16"><span class="invoicePrefix"></span>#<span class="noOfZero"></span></div>
                                                <input type="text"  class="form-control  form-control-lg readonly-background" readonly name="invoice_number" id="invoice_number" value="{{ $estimate->estimate_number }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-label-group form-group">     
                                        <input type="text" placeholder="-" class="form-control form-control-lg" name="valid_till" id="valid_till" value="{{ $estimate->valid_till->format($global->date_format) }}">
                                ...
                                <div class="col-md-2">
                                    <div class="form-label-group form-group">                                        
                                        ...
                                        <option
                                            ...
                                            <option
                                                    @if($estimate->status == 'Sent') selected @endif
                                            value="sent">@lang('modules.contracts.sent')
                                            </option>
                                            <option
                                                    @if($estimate->status == 'Expired') selected @endif
                                            ...
                                            <option
                                                    @if($estimate->status == 'waiting' || $estimate->status == 'declined') selected @endif
                                    ...
                                    @foreach($estimate->items as $key => $item)
                                        <div class="row item-row margin-top-5">
                                            ...
                                            <div class="col-md-2 border-dark  text-right resTextLeft">
                                                ...
                                                <p class="form-control-static">{{ $global->currency->currency_symbol }}<span
                                                            class="amount-html">{{currencyFormat($item->amount)}}</span></p>
                                                <input type="hidden" value="{{ $item->amount }}" class="amount"
                                                       name="amount[]">
                                            </div>

                                            <div class="col-md-1 text-right d-md-block d-none d-lg-block">
                                                <button type="button" class="btn remove-item btn-outline-danger"><i
                                                            class="fa fa-times"></i></button>
                                            </div>
                                            <div class="col-md-1 hidden-md hidden-lg m-b-20">
                                                    <button type="button" class="btn remove-item btn-outline-danger"><i class="fa fa-times"></i> @lang('app.remove')
                                                    </button>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="row">
                                            ...
                                            <p class="text-right col-xs-6 col-md-8">
                                                {{ $global->currency->currency_symbol }}<span class="sub-total">{{ number_format((float)$estimate->sub_total, 2, '.', '') }}</span>
                                            </p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-xs-6 col-md-4" >
                                                <select class="form-control" name="discount_type" id="discount_type">
                                                    ...
                                                    value="fixed">@lang('modules.estimate.amount')</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="invoice-taxes">
                                            <div class="row">
                                                <div class="col-md-4 col-xs-6 text-left p-b-10">
                                                    @lang('modules.invoices.tax')
                                                </div>                                               
            
                                                    <p class="text-right col-xs-6 col-md-8" >
                                                        {{ $global->currency->currency_symbol }}<span class="tax-percent">0</span>
                                                    </p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row m-t-5 font-bold total-amount">
                                            ...
                                            <p class="text-right col-xs-6 col-md-8">
                                                {{ $global->currency->currency_symbol }}<span class="total">{{ number_format((float)$estimate->total, 2, '.', '') }}</span>
                                            </p>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-label-group form-group">                                        
                                        <textarea placeholder="-" name="note" id="note" class="form-control" rows="5">{{ $estimate->note }}</textarea>
                        ...
                        <div class="form-actions col-md-6 offset-md-7">
                            <div class="row">
                                <div class="col-md-5 pr-0">
                                    <a href="{{ route('admin.estimates.index') }}" class="btn btn-outline-primary gray form-control" >@lang('app.cancel')</a>
                                </div>
                                <div class="col-md-5 pr-0">
        ...
        <div class="modal-dialog modal-md" id="modal-data-application">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modelHeading">Lead Sponsor</h5>
    ...
    function calculateTotal()
    {
        ...
        $.each( taxList, function( key, value ) {
            if(!isNaN(value)){
                ...
                tax = tax+'<div class="row"><div class="col-md-4 col-xs-6 text-left p-b-10">'
                    +key
                    +'</div>'
                    +'<p class="text-right col-xs-6 col-md-8" >'
