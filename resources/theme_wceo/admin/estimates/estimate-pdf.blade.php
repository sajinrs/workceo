...
<main>
    ...
    <table border="0" cellspacing="0" cellpadding="0">
            ...
            @foreach($estimate->items as $item)
                @if($item->type == 'item')
                    <tr style="page-break-inside: avoid;">
                        ...
                        <td class="qty"><h3><label style="color:#626262">$</label>{{ currencyFormat($item->unit_price) }}</h3></td>
                        <td class="unit"><label style="color:#626262">$</label>{{ currencyFormat($item->amount) }}</td>
                    </tr>
                @endif
            @endforeach
            <tr style="page-break-inside: avoid;" class="subtotal">
                ...
                <td class="unit"><label style="color:#626262">$</label>{{ currencyFormat($estimate->sub_total) }}</td>
            </tr>
            @if($discount != 0 && $discount != '')
                <tr style="page-break-inside: avoid;" class="discount">
                    ...
                    <td class="unit"><label style="color:#626262">$</label>-{{ number_format((float)$discount, 2, '.', '') }}</td>
                </tr>
            @endif
            @foreach($taxes as $key=>$tax)
                <tr style="page-break-inside: avoid;" class="tax">
                    ...
                    <td class="unit"><label style="color:#626262">$</label>{{ number_format((float)$tax, 2, '.', '') }}</td>
                </tr>
            @endforeach
            </tbody>
            <tfoot>
            <tr dontbreak="true">
                ...
                <td style="text-align: center"><label style="color:#626262">$</label>{{ currencyFormat($estimate->total) }}</td>
            </tr>
            </tfoot>
        </table>
        <p>&nbsp;</p>
