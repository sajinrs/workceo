            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="bookmark pull-right">
                        <a href="{{ route('admin.estimates.create') }}" class="btn btn-primary btn-sm">@lang('modules.estimates.createEstimate') <i data-feather="plus"></i> </a>

                        <a href="javascript:;" class="btn btn-outline-primary btn-sm page-tips-btn" onclick="getPageTips(8)"><span>@lang('app.menu.pageTips')</span> <i data-feather="alert-circle"></i></a>
                    </div>
                </div>
                <!-- Bookmark Ends-->
                    ...
                    @if($estimates == 0)
                        <div class="col-md-12 m-t-20">
                            <div class="empty-content text-center">
                                <img src="{{ asset('img/empty/estimates.jpg') }}" alt="user-img" /><br />
                                <b>No Estimates</b><br />
                                No estimates added yet.<br />
                                <a href="{{ route('admin.estimates.create') }}" class="btn btn-primary btn-sm m-t-20">Add Estimate</a>
                            </div>
                        </div>
                    @else  
                        ...
                        $.easyAjax({
                            ...
                            success: function (response) {
                                if (response.status == "success") {
                                    $.easyBlockUI('#estimates-table');
                                    window.LaravelDataTables["estimates-table"].search('').draw();
                                    $.easyUnblockUI('#estimates-table');
                                }
                            }
                        });
                    }
