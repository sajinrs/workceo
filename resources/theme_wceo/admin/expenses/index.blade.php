            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="bookmark pull-right">
                        <a href="{{ route('admin.expenses.create') }}" class="btn btn-primary btn-sm">@lang('modules.expenses.addExpense') <i data-feather="plus"></i> </a>

                        <a href="javascript:;" class="btn btn-outline-primary btn-sm page-tips-btn" onclick="getPageTips(11)"><span>@lang('app.menu.pageTips')</span> <i data-feather="alert-circle"></i></a>
                    </div>
                </div>
                <!-- Bookmark Ends-->
                                                    ...
                                                    <div class="product-filter">
                                                        <form action="" id="filter-form">
                                                            <div class="row"  id="ticket-filters">
                                                                ...
                                                                <div class="product-filter col-md-12">
                                                                    <div class="form-group">
                                                                    <label class="f-w-600">@lang('app.employee')</label>                                                                 
                                                                        <select class="form-control selectpicker" name="employee" id="employee" data-style="form-control">
                    ...
                    @if($expenseCount == 0)
                        <div class="col-md-12 m-t-20">
                            <div class="empty-content text-center">
                                <img src="{{ asset('img/empty/expense.jpg') }}" alt="user-img" /><br />
                                <b>No Expenses</b><br />
                                No expenses added yet.<br />
                                <a href="{{ route('admin.expenses.create') }}" class="btn btn-primary btn-sm m-t-20">Add Expense</a>
                            </div>
                        </div>
                    @else  
...
@push('footer-script')
    ...
    function loadTable(){
        window.LaravelDataTables["expenses-table"].search('').draw();
    }
