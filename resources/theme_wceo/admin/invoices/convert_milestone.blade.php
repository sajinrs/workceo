                    ...
                    <div class="card-body">
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-label-group form-group">     
                                    <input type="text" class="form-control form-control-lg" placeholder="-" name="due_date" id="due_date" value="{{ Carbon\Carbon::today()->addDays($invoiceSetting->due_after)->format($global->date_format) }}">
                            ...
                            <div class="d-md-block d-lg-block">
                                        ...
                                        <div class="row item-row margin-top-5">
                                                ...
                                                {{--<div class="row">--}}
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" class="form-control item_name" name="item_name[]" value="{{ $invoice->milestone_title }}" >
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <div class="row">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" min="" class="form-control cost_per_item" name="cost_per_item[]" value="{{ number_format((float)$invoice->cost, 2, '.', '')  }}" >
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="multiselect" name="taxes[][]"  multiple="multiple" class="js-example-basic-multiple form-control type">
                                            ...
                                            <div class="col-md-2 border-dark  text-center">
                                                ...
                                                <input type="hidden" value="{{ $invoice->cost }}" class="amount" name="amount[]">
                                            </div>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-offset-9 col-md-9 col-xs-6 text-right p-t-10">
    ...
    function calculateTotal()
    {
        ...
        $.each( taxList, function( key, value ) {
            if(!isNaN(value)){
                ...
                tax = tax+'<div class="row"><div class="col-md-offset-9 col-md-9 col-xs-6 text-right p-t-10">'
                    +key
                    +'</div>'
                    +'<p class="form-control-static col-xs-6 col-md-2" >'
