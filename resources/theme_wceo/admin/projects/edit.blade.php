            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="card-title mb-0 h4"> @lang('modules.projects.editTitle')</div>
                    ...
                    <div class="card-body">
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 ">
                                    <div class="form-group">
                                        <a href="javascript:;" id="addProjectCategory" class="btn-outline btn-block btn btn-sm btn-primary"><i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-label-group form-group"> 
                                                ...
                                                <option data-percentage="0" data-jobstatus="schedule" @if($project->job_status == 'schedule') selected @endif value="not started">Scheduled</option>
                                                <option data-percentage="17" data-jobstatus="omw" @if($project->job_status == 'omw') selected @endif value="not started">En Route</option>
                                                <option data-percentage="33" data-jobstatus="start" @if($project->job_status == 'start') selected @endif value="in progress">Started</option>
                                                <option data-percentage="50" data-jobstatus="finish" @if($project->job_status == 'finish') selected @endif value="in progress">Finished</option>
                                                <option data-percentage="66" data-jobstatus="invoice" @if($project->job_status == 'invoice') selected @endif value="awaiting invoice">Invoiced</option>
                                                <option data-percentage="83" data-jobstatus="paid" @if($project->job_status == 'paid') selected @endif value="awaiting pay">Paid</option>
                                                <option data-percentage="100" data-jobstatus="closed" @if($project->job_status == 'closed') selected @endif value="finished">Closed</option>
                                                    {{--<option
                                                ...
                                                <input type="hidden" id="jobStatus" name="job_status" value="{{$project->job_status}}" />
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                               ...
                               <?php //print_r($project->vehicles); die('s'); ?>
                               @php $projVehicles[] = ''; @endphp
                                @if(!empty($project->vehicles))
                                    @foreach($project->vehicles as $vehicle)
                                        @php $projVehicles[] = $vehicle->vehicle_id; @endphp
                                    @endforeach
                                @endif
                                    ...
                                    <div class="form-group">
                                        <select class="select2 m-b-10 select2-multiple form-control " multiple="multiple"
                                            ...
                                            @foreach($vehicles as $vehicle)
                                                <option @if (isset($project->vehicles) && in_array($vehicle->id, $projVehicles) !== false) selected @endif value="{{ $vehicle->id }}">{{ ucwords($vehicle->vehicle_name). ' ['.$vehicle->license_plate.']' }} 
                                                </option>
                                            @endforeach
                                        </select>                                       
                                    </div>
                            ...
                            <div class="d-md-block d-lg-block ">
                                ...
                                <hr />
                                <div class="row">
                                    <div class="col-md-12 m-t-10"><h5>Invoices</h5></div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    @if(!empty($invoice->items))
                                        <div class="row">
                                            <div class="col-12 ">
                                                <div class="row">
                                                    <div class="col-md-4 text-left resTextLeft" >@lang('modules.invoices.subTotal')</div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 text-left resTextLeft">
                        ...
                        <div class="form-actions col-md-6 offset-md-7">
                            <div class="row">
                                <div class="col-md-5 pr-0">
                                    <a href="{{ route('admin.projects.index') }}" class="btn btn-outline-primary gray form-control" >@lang('app.cancel')</a>
                                </div>
                                <div class="col-md-5 pr-0">
...
$('#add-item').click(function () {
    ...
    function calculateTotal(){
        ...
        $.each( taxList, function( key, value ) {
            if(!isNaN(value)){
                tax = tax+'<div class="col-md-4 text-left p-b-10 resTextLeft">'
                    +key
                    +'</div>'
