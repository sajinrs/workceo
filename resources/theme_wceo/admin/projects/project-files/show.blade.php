...
<div class="container-fluid product-wrapper">
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="pull-left">@lang('modules.projects.files')</h5>
            <div class="pull-right">
                <a href="javascript:;" id="show-dropzone" class="btn btn-primary btn-outline btn-sm"><i class="fa fa-upload"></i> @lang('modules.projects.uploadFile')</a>
            </div>
        </div>
                    ...
                    <div class="tab-pane fade active show" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row m-b-20 d-none" id="file-dropzone">
                                <div class="col-md-12">
                                    <form class="dropzone dropzone-primary" id="multiFileUpload" action="{{ route('admin.files.store') }}" >
