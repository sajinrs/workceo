...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <section>
                <div class="sttabs tabs-style-line"> @include('admin.projects.show_project_menu')  </div>
            </section>
        </div>
    </div>
    <!-- .row -->
...
&markers=icon:https://mysmartassistants.com/works/workceo/public/img/blue_mark.png%7Clabel:%7C{{$project->client->address}}&key=AIzaSyCsLN7tz9Ww5Lt2hDS4KqaBrb8clNSwdkQ" alt="{{$project->client->address}}" border="0" width="100%">
                ...
                <div class="col-md-12">
                    ...
                    <button type="button" id="accept_action" class="btn btn-sm btn-primary pull-right m-b-20" onclick="sign();return false;"> @lang('app.sign')</button>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 pr-0">                    
                    ...
                    <div class="card-header m-b-10">
                            ...
                            <h4 class="card-title mb-0">Job Status 
                                <a href="javascript:;" data-toggle="tooltip" data-original-title="Update Status" id="UpdateStatus"><i class="icofont icofont-gear"></i></a>
                                <a href="{{ route('admin.projects.edit', $project->id) }}" class="pull-right btn btn-sm btn-primary"><i class="fa fa-edit" aria-hidden="true"></i> @lang('modules.jobs.jobEdit')</a>
                            </h4>                   
...
function sign() 
{
    var url = '{{ route('admin.project.sign-modal', $project->id) }}';
    $.ajaxModal('#projectStatusModal', url);
}
...
<script>
            @if($credentials->stripe_status == 'active' && !empty($invoices))
