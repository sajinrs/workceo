                ...
                <div class="col">
                    <div class="page-header-left">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">@lang('app.add') Group Task</li>
                        </ol>
                    </div>
                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-label-group form-group">                                   
                                                                <input placeholder="-" type="text" id="cat_name" name="cat_name" class="form-control-lg form-control">
...
<script>
    ...
    $('#save-form').click(function () {
        $.easyAjax({
            url: '{{route('admin.task-groups.store')}}',
