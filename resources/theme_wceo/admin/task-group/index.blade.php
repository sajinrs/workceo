        ...
        <div class="col-md-9">
            <div class="card">
                <div class="panel panel-inverse">
                    ...
                    <a href="{{ route('admin.task-groups.create') }}" class="btn btn-primary btn-sm">@lang('app.addNew') Group <i class="fa fa-plus"></i> </a>
                </div>
                    </div>
                    <div  class="card-body">
                        <div class="form-body" >
        ...
        $(function() {
            ...
            $('body').on('click', '.sa-params', function () {
                ...
                swal({
                    ...
                    title: "Are you sure?",
                    text: "You will not be able to recover the deleted group task!",
            ...
            .then((willDelete) => {
                    if (willDelete) {
                        ...
                        var url = "{{ route('admin.task-groups.destroy',':id') }}";
                        ...
                        $.easyAjax({
                            ...
                            success: function (response) {
                                if (response.status == "success") {
                                    $.unblockUI();
                                    LaravelDataTables["group-task-table"].draw();
                                }
                            }
                        });
                    }
