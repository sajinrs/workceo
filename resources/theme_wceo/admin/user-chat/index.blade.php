            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="bookmark pull-right">
                        ...
                        <a href="javascript:;" class="btn btn-outline-primary btn-sm page-tips-btn" onclick="getPageTips(17)"><span>@lang('app.menu.pageTips')</span> <i data-feather="alert-circle"></i></a>
                    </div>
                </div>
                <!-- Bookmark Ends-->
              ...
              <div class="col-md-6 call-chat-body">
                  ...
                  <div class="col-md-12 m-t-120">
                        <div class="empty-content text-center">
                            <img src="{{ asset('img/empty/chat.jpg') }}" alt="user-img" /><br />
                            <b>No Chats</b><br />
                            No chat discussion in your history.<br />
                            <a href="javascript:;" id="new-chat2" class="btn btn-primary btn-sm m-t-20">Start Conversation</a>
                        </div>
                    </div>
                  @else
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 d-flex">
                                        ...
                                        <div class="input-group-append">
                                            <button id="submitBtn" class="btn btn-primary" type="submit">@lang("modules.messages.send")</button>
                                        </div>
                                        </div>
                                    </div>
                                </div>
...
{{--											<option value="available"><i class="fa fa-user"></i>Available</option>--}}
{{--											<option value="busy"><i class="fa fa-user"></i>Busy</option>--}}
{{--											<option value="do not disturb"><i class="fa fa-user"></i>Do not disturb</option>--}}
{{--											<option value="be right back"><i class="fa fa-user"></i>Be right back</option>--}}
{{--											<option value="away"><i class="fa fa-user"></i>Away</option>--}}
						  				</select>
						  				</p>
...
$(document).ready(function(){
    ...
    $('#userStatus').change(function(){
        var status = $(this).val();
        var url = "{{ route('admin.user-chat.chat-status') }}";
    ...
    $('.emoji_icon').on('click',function () {
        ...
        var url = "{{ route('admin.user-chat.emoji-submit') }}";
        var token = "{{ csrf_token() }}";
        $.easyAjax({
            type: 'POST',
            url: url,
	...
	{
		var url = "{{ route('admin.user-chat.member-media',':id') }}";
    ...
    $('#new-chat, #new-chat2').click(function () {
