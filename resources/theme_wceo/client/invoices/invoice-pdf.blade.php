    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($invoice->items as $item)
            ...
            <tr style="page-break-inside: avoid;">
                ...
                <td class="qty"><h3>{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ currencyFormat($item->unit_price) }}</h3></td>
                <td class="unit">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ currencyFormat($item->amount) }}</td>
            </tr>
            @endif
        @endforeach
        <tr style="page-break-inside: avoid;" class="subtotal">
            ...
            <td class="unit">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ currencyFormat($invoice->sub_total) }}</td>
        </tr>
        ...
        @foreach($taxes as $tax)
            <tr style="page-break-inside: avoid;" class="tax">
                ...
                <td class="unit">{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ currencyFormat($tax->amount) }}</td>
            </tr>
        @endforeach
        </tbody>
        <tfoot>
        <tr dontbreak="true">
            ...
            <td>{!! htmlentities($invoice->currency->currency_symbol)  !!}{{ currencyFormat($invoice->total) }}</td>
        </tr>
        </tfoot>
    </table>
    <p>&nbsp;</p>
