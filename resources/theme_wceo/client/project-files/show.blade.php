...
@include('client.projects.show_project_menu')
                    ...
                    <div class="tab-pane fade active show" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row m-b-20 d-none" id="file-dropzone">
                                <div class="col-md-12">
                                    <form class="dropzone dropzone-primary" id="multiFileUpload" action="{{ route('client.files.store') }}" >
 ...
 <small class="text-muted m-r-10">{{ $file->created_at->diffForHumans() }}</small>
                                                ...
                                                &nbsp;&nbsp;
                                                <a href="{{ route('client.files.download', $file->id) }}" data-toggle="tooltip" data-original-title="Download" class="btn btn-small badge-dark"><i class="fa fa-download"></i></a>
                                                &nbsp;&nbsp;
