    ...
    <table border="0" cellspacing="0" cellpadding="0">
        ...
        @foreach($invoice->items as $item)
            ...
            <tr style="page-break-inside: avoid;">
                ...
                <td class="qty"><h3>{{ currencyFormat($item->unit_price) }}</h3></td>
                <td class="unit">{{ currencyFormat($item->amount) }}</td>
            </tr>
            @endif
        @endforeach
        <tr style="page-break-inside: avoid;" class="subtotal">
            ...
            <td class="unit">{{ currencyFormat($invoice->sub_total) }}</td>
        </tr>
        ...
        <tr style="page-break-inside: avoid;" class="discount">
            ...
            <td class="unit">-{{ currencyFormat($discount) }}</td>
        </tr>
        @endif
        ...
        <tfoot>
            <tr dontbreak="true">
                ...
                <td style="text-align: center">{{ currencyFormat($invoice->total) }}</td>
            </tr>
            ...
            <tr dontbreak="true">
                ...
                <td style="text-align: center">{{ currencyFormat($invoice->amountPaid()) }}</td>
            </tr>
            <tr dontbreak="true">
                <td colspan="4">@lang("modules.invoices.total") @lang("modules.invoices.due")</td>
                <td style="text-align: center">{{ currencyFormat($invoice->amountDue()) }}</td>
            </tr>
        </tfoot>
    </table>
    <p>&nbsp;</p>
