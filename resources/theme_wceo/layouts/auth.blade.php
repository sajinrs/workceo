...
<head>
    ...
    @if (Request::is('signup'))
        @php $bgImage = $setting->signup_background_url; @endphp
    @else
        @php $bgImage = $setting->login_background_url; @endphp
    @endif
    <style>
        #background-section {
            background: url("{{ $bgImage }}") center center/cover no-repeat !important;
        }
        #auth-logo {
...
<div class="container-fluid">
  <div class="row">
    <div class="col-xs-12 col-lg-5" id="form-section">
        <div id="auth-logo">
            <img src="{{ $setting->logo_front_url }}" style="width: 100%" alt="Logo" />
        </div>
...
<script>
localStorage.setItem('adsPopState','hide');
localStorage.setItem('adsToasterState','hide');
</script>
