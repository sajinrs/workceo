                ...
                <ul class="nav-menus">
                    ...
                    <li class="onhover-dropdown">
                        ...
                        <ul class="profile-dropdown wceo-admin onhover-show-div p-20">
                            ...
                            <li><a href="{{ route('client.profile.index') }}"><i class="fa fa-cog"></i> @lang("app.menu.profileSettings")</a></li>                            <li><a href="{{ route('logout') }}" onclick="event.preventDefault();
        ...
        $.easyAjax({
            ...
            success: function (data) {
                if (data.status == 'success') {
                    ...
                    var notifications = '{{ route('client.notices.index') }}';
