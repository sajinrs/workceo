                ...
                <div class="card">
                        ...
                        <h5 class="mb-4">@lang('modules.lead.leadDetails')</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12 p-0">
                                        <div class="form-label-group form-group">
                                            <select placeholder="-" name="status" id="status" class="select2 form-control-lg form-control">
                                    ...
                                    <div class="col-md-12 p-0">
                                        <div class="form-label-group form-group">
                                            <select placeholder="-" name="source" id="source" class="select2 form-control-lg form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group form-group">
                                        <textarea placeholder="-" name="note" id="note" class="form-control-lg form-control" rows="10">{{ $lead->note ?? '' }}</textarea>
                    ...
                    <div class="card-footer text-right">
                        <div class="form-actions row">
                            ...
                            <div class="col-md-3">
                                <a href="{{ route('admin.leads.index') }}" class="btn btn-secondary form-control">@lang('app.back')</a>
                            </div>
                    </div>
                    </div>
                    {!! Form::close() !!}
