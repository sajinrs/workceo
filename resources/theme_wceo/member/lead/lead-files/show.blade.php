                ...
                <div class="col">
                    <div class="page-header-left">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('member.leads.index') }}">@lang('modules.lead.lead')</a></li>
            ...
            <div class="row product-page-main">
                <div class="col-sm-12">
                    <ul class="nav nav-tabs border-tab mb-0" id="top-tab" role="tablist">
                        ...
                        <li  class="nav-item"><a class="nav-link active" href="{{ route('member.lead-files.show', $lead->id) }}"><span>@lang('modules.lead.file')</span></a></li>
                        <li class="nav-item"><a class="nav-link" href="{{ route('member.leads.followup', $lead->id) }}"><span>@lang('modules.lead.followUp')</span></a></li>
                        @endif
                    </ul>
                </div>

                <div class="col-sm-12" id="files-list-panel">
                                ...
                                <div class="row m-b-10">
                                    <div class="col-md-12">
                                        <a href="javascript:;" id="show-dropzone"
                                           class="btn btn-primary btn-outline"><i class="fa fa-upload"></i> @lang('modules.projects.uploadFile')</a>
                                    </div>
                                </div>
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="list">
                                        <ul class="list-group m-t-15" id="files-list">
                                            ...
                                            <li class="list-group-item justify-content-between align-items-center">
                                                ...
                                                &nbsp;&nbsp;
                                                <a href="{{ route('admin.lead-files.download', $file->id) }}" data-toggle="tooltip" data-original-title="Download" class="badge badge-dark"><i class="fa fa-download"></i></a>
                                                &nbsp;&nbsp;
                                                <a href="javascript:;" data-toggle="tooltip" data-original-title="Delete" data-file-id="{{ $file->id }}" class="badge badge-danger sa-params" data-pk="list"><i class="fa fa-times"></i></a>
                                                    </span>
                                            </li>
                                            @empty
