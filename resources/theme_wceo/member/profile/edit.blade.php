                                ...
                                <div class="card">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-label-group form-group">    
                                                    <input type="tel" name="mobile" id="mobile" class="form-control form-control-lg" placeholder="-" value="{{ $userDetail->mobile }}">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-label-group form-group">
                                                    <select name="gender" id="gender" class="form-control form-control-lg" placeholder="-">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-label-group form-group">   
                                                    <textarea name="address" id="address" rows="5"
                                                            class="form-control form-control-lg">@if(!empty($employeeDetail)){{ $employeeDetail->address }}@endif</textarea>
