...
<div class="modal-header">
    <h5 class="modal-title">@lang('modules.timeLogs.startTimer')</h5>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    @if($logTimeFor->log_time_for == 'task')
                        <select class="select2 form-control form-control-lg" name="project_id" data-placeholder="@lang('app.selectTask')" id="task_id">
                            <option value=""></option>
                    ...
                    @else
                        <select class="select2 form-control form-control-lg" name="project_id" id="project_id" >
...
<div class="form-actions">
    <button type="button" id="start-timer-btn" class="btn btn-primary"> @lang('modules.timeLogs.startTimer')</button>
</div>
</div>
