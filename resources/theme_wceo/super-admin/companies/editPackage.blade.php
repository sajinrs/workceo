<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            ...
            <select name="package" id="packageName" class="js-example-basic-single col-sm-12">
    ...
    <div class="col-md-6">
        <div class="form-group">
            <div class="col-form-label">Package Type</div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            <label class="control-label" for="packageAmount">Amount</label>
            <input type="text" name="amount" id="packageAmount" class="form-control"
                   value="{{ !empty($currentPackage) ? $currentPackage->{$company->package_type . '_price'} : ''}}">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="pay_date" id="pay_date" class="form-control"
                   value="{{ $lastInvoice && $lastInvoice->pay_date ? $lastInvoice->pay_date->format('m/d/Y') : ''}}">
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="next_pay_date" id="next_pay_date" class="form-control"
                   value="{{ $lastInvoice && $lastInvoice->next_pay_date ? $lastInvoice->next_pay_date->format('m/d/Y') : ''}}">
        </div>
    </div>
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" name="licence_expires_on" id="licence_expires_on" class="form-control"
                   value="{{ $company->licence_expire_on ? $company->licence_expire_on->format('m/d/Y') : ''}}"
                   disabled="disabled">
        </div>
    </div>
    <div class="col-md-12">
