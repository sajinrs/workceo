            ...
            <div class="white-box">
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-list">
                                <label class="radio-inline p-0">
                                    <div class="radio radio-info">
                                        <input type="radio" name="is_cryptocurrency"
                                               @if($currency->is_cryptocurrency == 'yes') checked
                                               @endif id="crypto_currency_yes" value="yes">
                                ...
                                <label class="radio-inline">
                                    <div class="radio radio-info">
                                        <input type="radio" name="is_cryptocurrency"
                                               @if($currency->is_cryptocurrency == 'no') checked
                                               @endif id="crypto_currency_no" value="no">
                        ...
                        <div class="form-group crypto-currency"
                             @if($currency->is_cryptocurrency == 'no') style="display: none" @endif>
                            <label for="usd_price">@lang('modules.currencySettings.usdPrice') <a class="mytooltip"
                        ...
                        <div class="form-group regular-currency"
                            ...
                            <a href="javascript:;" id="fetch-exchange-rate"><i class="fa fa-refresh fa-spin"></i> Fetch
                                latest exchange rate</a>
                        </div>
