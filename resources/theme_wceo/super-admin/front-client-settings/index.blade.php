                ...
                <div class="card">
                    <div class="panel panel-inverse">
                        <div class="card-header">
                            <h5>@lang('app.frontClient') @lang('app.frontClient')</h5>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="title"
                                                                       name="title"
                                                                       value="{{ $frontDetail->client_title }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" id="detail" rows="5"
                                                                          name="detail">{{ $frontDetail->client_details }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <div class="text-right">
                                                                    <a href="javascript:;"
                                                                       class="btn btn-outline btn-primary btn-sm addFeature">@lang('app.add') @lang('app.frontClient')
                                                                        <i class="fa fa-plus"
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            @forelse($frontClients as $frontClient)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <img height="40" width="80" class="img-fluid"
                                                                             src="{{ $frontClient->image_url }}"
                                                                             alt=""/>
                                                                    </td>
                                                                    <td class="text-nowrap">
                                                                        <a href="javascript:;"
                                                                           data-feature-id="{{ $frontClient->id }}"
