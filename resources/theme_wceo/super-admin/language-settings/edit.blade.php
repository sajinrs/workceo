                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   value="{{ $languageSetting->language_name }}"
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   value="{{ $languageSetting->language_code }}"
                                                    ...
                                                    <div class="col-sm-12 col-md-6 col-xs-12">
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <select class="form-control" name="status">
                                                                <option @if($languageSetting->status == 'enabled') selected
                                                                        @endif value="enabled">@lang('app.enabled')</option>
                                                                <option @if($languageSetting->status == 'disabled') selected
