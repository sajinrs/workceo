            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card-header">
                        <h4 class="card-title mb-0">@lang('app.update') @lang('app.template') @lang('app.info')</h4>
                        ...
                        <div class="form-body">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="max_employees" id="max_employees"
                                               value="{{ $package->max_employees ?? '' }}" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" @if($package->default == 'yes') readonly  @endif name="annual_price" id="annual_price"
                                               value="{{ $package->annual_price ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label class="control-label required">@lang('app.monthly') @lang('app.price')
                                            ({{ $global->currency->currency_symbol }})</label>
                                        <input type="number"  @if($package->default == 'yes') readonly @endif  name="monthly_price" id="monthly_price"
                                               value="{{ $package->monthly_price ?? '' }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-primary">
                                            <input id="free_trial" type="checkbox" name="free_trial" @if(!empty($package->free_trial_days)) checked @endif value="yes" />
                                            <label for="free_trial"> Free Trial</label>
                                        </div>
                                    </div>
                                </div>

                                <div id="trialDays" class="col-md-4 @if($package->free_trial_days == 0) d-none @endif">
                                    <div class="form-group">
                                        <label class="control-label required">Days</label>
                                        <input type="number" name="trial_days" id="days" value="{{ $package->free_trial_days ?? 0 }}" class="form-control" />
                                    </div>
                                </div>
                            </div>
                           ...
                           <hr class="mt-4 mb-4">
                                        ...
                                        @foreach($modules as $module)
                                            ...
                                            <div class="col-md-2">
                                                <div class="checkbox checkbox-inline checkbox-info m-b-10">
                                                    <input class="module_checkbox" id="{{ $module->module_name }}"
                                                           name="module_in_package[{{ $module->id }}]"
                                                           value="{{ $module->module_name }}" type="checkbox"
                                                           @if(isset($packageModules) && in_array($module->module_name, $packageModules) ) checked @endif >
                            ...
                            <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" >
                                            <img id="profImage" src="{{ $package->image_url}}" alt=""/>
                                ...
                                <!-- <div class="col-md-12">
                                    <label>Plan Image (325x205)</label>
                                    <div class="form-group">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
