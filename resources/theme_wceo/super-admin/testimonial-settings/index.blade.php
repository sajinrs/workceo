                ...
                <div class="card">
                    <div class="panel panel-inverse">
                        <div class="card-header">
                            <h5>@lang('app.testimonial') @lang('app.menu.settings')</h5>
                        </div>
                        <div class="card-body">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-xs-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="title"
                                                                       name="title"
                                                                       value="{{ $frontDetail->testimonial_title }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="form-group">
                                                                <div class="text-right">
                                                                    <a href="javascript:;"
                                                                       class="btn btn-outline btn-primary btn-sm addFeature">@lang('app.add') @lang('app.testimonial')
                                                                        <i class="fa fa-plus"
                                                            ...
                                                            @forelse($testimonials as $testimonial)
                                                                <tr>
                                                                    ...
                                                                    <td class="text-nowrap">
                                                                        <a href="javascript:;"
                                                                           data-feature-id="{{ $testimonial->id }}"
