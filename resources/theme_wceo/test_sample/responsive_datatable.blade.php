...
@push('footer-script')
    ...
    {{--<script src="{{ asset('themes/wceo/assets/js/datatable/datatable-extension/dataTables.keyTable.min.js')}}"></script>--}}
    {{--<script src="{{ asset('themes/wceo/assets/js/datatable/datatable-extension/dataTables.colReorder.min.js')}}"></script>--}}
    {{--<script src="{{ asset('themes/wceo/assets/js/datatable/datatable-extension/dataTables.fixedHeader.min.js')}}"></script>--}}
    {{--<script src="{{ asset('themes/wceo/assets/js/datatable/datatable-extension/dataTables.rowReorder.min.js')}}"></script>--}}
    {{--<script src="{{ asset('themes/wceo/assets/js/datatable/datatable-extension/dataTables.scroller.min.js')}}"></script>--}}
