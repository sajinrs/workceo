<div class="navbar-default sidebar" role="navigation">
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            <li><a href="{{ route('member.user-chat.index') }}" class="waves-effect"><i class="icofont icofont-ui-text-loading"></i> <span class="hide-menu">@lang("app.menu.messages") @if($unreadMessageCount > 0)<span class="label label-rouded label-custom pull-right">{{ $unreadMessageCount }}</span> @endif
                    </span>
                </a>
            </li>
            @endif
