...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        //Page Tips Routes
        Route::get('pagetips/modules/data', ['uses' => 'SuperAdminPageTipController@data'])->name('pagetips.modules.data');
        Route::resource('pagetips', 'SuperAdminPageTipController');
        Route::post('pagetips/sort/{category}', ['uses' => 'SuperAdminPageTipController@articleSort'])->name('pagetips.article.sort');
        
        Route::get('pagetips/article/{category}', ['uses' => 'SuperAdminPageTipController@articleCreate'])->name('pagetips.article.create');
        Route::get('/pagetips/{category}/edit-article/{id}', ['uses' => 'SuperAdminPageTipController@articleEdit'])->name('pagetips.article.edit');

        Route::post('/pagetips/store-article/{category}', ['uses' => 'SuperAdminPageTipController@articleStore'])->name('pagetips.store-article');
        Route::post('/pagetips/update-article/{category}/{id}', ['uses' => 'SuperAdminPageTipController@articleUpdate'])->name('pagetips.update-article');
        Route::delete('/pagetips/destroy-article/{category}/{id}', ['uses' => 'SuperAdminPageTipController@articleDestroy'])->name('pagetips.destroy-article');  

       

        // Packages routes
        Route::get('packages/data', ['uses' => 'SuperAdminPackageController@data'])->name('packages.data');
        Route::post('packages/activate/{package_id}', ['uses' => 'SuperAdminPackageController@activate'])->name('packages.activate');
        Route::resource('/packages', 'SuperAdminPackageController');
        Route::put('packages/update-pack-banner/{companyId}', ['uses' => 'SuperAdminPackageController@updatePackBanner'])->name('packages.update-pack-banner');
        ...
        //Ads Space
        Route::get('ads-space/data', ['uses' => 'SuperAdminAdsController@data'])->name('ads-space.data');
        Route::resource('/ads-space', 'SuperAdminAdsController');

        Route::resource('/onboarding', 'SuperAdminBoardingController', ['only' => ['index', 'store', 'edit', 'update', 'destroy']]);
        Route::get('onboarding/create', ['uses' => 'SuperAdminBoardingController@create'])->name('onboarding.create');
        Route::get('onboarding/data', ['uses' => 'SuperAdminBoardingController@data'])->name('onboarding.data');
        ...
        Route::get('test-map', ['uses' => 'SuperAdminTestMapController@index'])->name('super-admin-test-map');
        Route::get('test-map/getlocs', ['uses' => 'SuperAdminTestMapController@getlocs'])->name('super-admin-test-map-getlocs');
    ...
    Route::group(
        ...
        function () {
            Route::group(['middleware' => ['account-setup', 'license-expire']], function () {
                ...
                Route::get('/dashboard/job-block/{date_range}', 'AdminDashboardController@jobBlock')->name('dashboard.job-block');
                Route::get('/dashboard/revenue-block/{date_range}', 'AdminDashboardController@revenueBlock')->name('dashboard.revenue-block');
                Route::get('/dashboard/leadboard-block/{date_range}', 'AdminDashboardController@leadboardBlock')->name('dashboard.leadboard-block');
                Route::get('/dashboard/invoice-block/{date_range}', 'AdminDashboardController@invoiceBlock')->name('dashboard.invoice-block');
                Route::get('/dashboard/map-block/{date_range}', 'AdminDashboardController@mapBlock')->name('dashboard.map-block');

                Route::post('update-company', ['uses' => 'AdminDashboardController@updateCompany'])->name('dashboard.update-company');
                Route::post('add-checklist', ['uses' => 'AdminDashboardController@addChecklist'])->name('dashboard.add-checklist');
                ...
                Route::post('faqs/search', ['uses' => 'FaqController@search'])->name('faqs.search');
                Route::get('faqs/faq-view/{id?}', ['uses' => 'FaqController@viewFaq'])->name('faqs.faq-view');

                //Map
                Route::get('map', ['uses' => 'MapController@index'])->name('map.index');
                Route::post('map/filter', ['uses' => 'MapController@filter'])->name('map.filter');
                Route::get('map/show-vehicle/{id}', ['uses' => 'MapController@showVehicle'])->name('map.show-vehicle');


                Route::get('checklist-setup', ['uses' => 'AdminDashboardController@checklistSetup'])->name('dashboard.checklist-setup');
                Route::get('onboarding-view/{id?}', ['uses' => 'AdminDashboardController@viewOnBoarding'])->name('dashboard.onboarding-view');
                ...
                Route::resource('all-contacts', 'ContactsController');
                ...
                Route::post('leads/import-template-download', ['uses' => 'LeadController@downloadCSVTemplate'])->name('leads.import-template-download');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::post('import', ['uses' => 'ManageEmployeesController@import'])->name('employees.import');
                        Route::post('import-template-download', ['uses' => 'ManageEmployeesController@downloadCSVTemplate'])->name('employees.import-template-download');


                        Route::get('create-skill', ['uses' => 'ManageEmployeesController@createSkill'])->name('employees.create-skill');
                        Route::post('store-skill', ['uses' => 'ManageEmployeesController@storeSkill'])->name('employees.store-skill');
                        Route::delete('destroy-skill', ['uses' => 'ManageEmployeesController@destroySkill'])->name('employees.destroy-skill');
                ...
                Route::get('projects/activities/{limit?}', ['uses' => 'ManageNewProjectsController@getActivities'])->name('projects.activities');

                Route::post('projects/gantt-task-update/{id}', ['uses' => 'ManageNewProjectsController@updateTaskDuration'])->name('projects.gantt-task-update');
                Route::get('projects/ajaxCreate/{columnId}', ['uses' => 'ManageNewProjectsController@ajaxCreate'])->name('projects.ajaxCreate');
                Route::get('projects/archive-data', ['uses' => 'ManageNewProjectsController@archiveData'])->name('projects.archive-data');
                Route::get('projects/archive', ['uses' => 'ManageNewProjectsController@archive'])->name('projects.archive');
                Route::get('projects/archive-restore/{id?}', ['uses' => 'ManageNewProjectsController@archiveRestore'])->name('projects.archive-restore');
                Route::get('projects/archive-delete/{id?}', ['uses' => 'ManageNewProjectsController@archiveDestroy'])->name('projects.archive-delete');
                Route::get('projects/export/{status?}/{clientID?}', ['uses' => 'ManageNewProjectsController@export'])->name('projects.export');
                Route::get('projects/ganttData/{projectId?}', ['uses' => 'ManageNewProjectsController@ganttData'])->name('projects.ganttData');
                Route::get('projects/gantt/{projectId?}', ['uses' => 'ManageNewProjectsController@gantt'])->name('projects.gantt');
                Route::get('projects/burndown/{projectId?}', ['uses' => 'ManageNewProjectsController@burndownChart'])->name('projects.burndown-chart');
                Route::post('projects/updateStatus/{id}', ['uses' => 'ManageNewProjectsController@updateStatus'])->name('projects.updateStatus');

                Route::get('projects/job-status/{id}', ['uses' => 'ManageNewProjectsController@jobStatus'])->name('projects.job-status');
                Route::post('projects/update-job-status/{id}', ['uses' => 'ManageNewProjectsController@updateJobStatus'])->name('projects.update-job-status');
                Route::get('projects/copy/{id}', ['uses' => 'ManageNewProjectsController@copy'])->name('projects.copy');

                Route::get('projects/sign/{id}', ['as' => 'project.sign-modal', 'uses' => 'ManageNewProjectsController@projectSignModal']);
                Route::post('projects/sign/{id}', ['as' => 'project.sign', 'uses' => 'ManageNewProjectsController@projectSign']);

                Route::get('projects/archive/{id?}', ['uses' => 'ManageNewProjectsController@showArchive'])->name('projects.archive-details');

                Route::resource('projects', 'ManageNewProjectsController');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        //Route::post('project-members/delete-all', ['uses' => 'ManageProjectMembersController@deleteAll'])->name('project-members.delete-all');
                        Route::delete('project-members/delete-all/{id}', 'ManageProjectMembersController@deleteAll')->name('project-members.delete-all');
                        ...
                        Route::post('tasks/builk-action', 'ManageTasksController@bulkAction')->name('tasks.builk-action');

                        Route::get('tasks/show-category-task/{catId?}', 'ManageTasksController@showCategoryTask')->name('tasks.show-category-task');

                        Route::post('tasks/store-group-task', 'ManageTasksController@storeGroupTask')->name('tasks.store-group-task');
                        ...
                        Route::get('invoices/offline-payment/{id?}', ['uses' => 'ManageInvoicesController@offlinePayment'])->name('invoices.offline-payment');

                        Route::get('invoices/data/{id}', ['uses' => 'ManageInvoicesController@data'])->name('invoices.data');
                        
                        Route::post('invoices/offline-payment-submit', 'ManageInvoicesController@offlinePaymentSubmit')->name('invoices.offline-payment-submit');
                ...
                Route::group(
                    ...
                    function() {
                        ...
                        Route::get('estimates/{id}', ['uses' => 'ManageClientsController@showEstimates'])->name('clients.estimates');
                        Route::post('import', ['uses' => 'ManageClientsController@import'])->name('clients.import');
                        Route::post('import-template-download', ['uses' => 'ManageClientsController@downloadCSVTemplate'])->name('clients.import-template-download');
                        ...
                        Route::get('properties/{id}', ['uses' => 'ClientPropertiesController@showProperties'])->name('clients.properties');
                        Route::get('properties/data/{id}', ['uses' => 'ClientPropertiesController@data'])->name('properties.data');
                        Route::resource('properties', 'ClientPropertiesController');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        //Archive
                        Route::get('archive', ['uses' => 'ManageAllTasksController@archiveData'])->name('task.archive');
                        Route::get('archive-restore/{id?}', ['uses' => 'ManageAllTasksController@archiveRestore'])->name('task.archive-restore');
                ...
                Route::get('reports', ['uses' => 'ReportsController@index'])->name('reports.index');
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::resource('property-report', 'PropertyReportController');
                        //endregion
                    });
                ...
                Route::group(
                    ...
                    function () {
                        ...
                        Route::get('all-invoices/update-item-project', ['uses' => 'ManageAllInvoicesController@addItemsProject'])->name('all-invoices.update-item-project');
                        Route::get('all-invoices/update-item-event', ['uses' => 'ManageAllInvoicesController@addItemsEventProject'])->name('all-invoices.update-item-event');
                        ...
                        Route::get('all-invoices/update-status/{invoiceID}', ['uses' => 'ManageAllInvoicesController@uncancelStatus'])->name('all-invoices.update-status');

                        Route::resource('all-invoices', 'ManageAllInvoicesController');

                        Route::get('all-invoices/get-category-products/{cat_id?}', ['uses' => 'ManageAllInvoicesController@getCategoryProducts'])->name('all-invoices.get-category-products');
                        ...
                        Route::get('payments/get-client-projects/{client_id?}', ['uses' => 'ManagePaymentsController@getClientProjects'])->name('payments.get-client-projects');

                        Route::post('payments/offline-payment-submit', 'ManagePaymentsController@offlinePaymentSubmit')->name('payments.offline-payment-submit');
                    });
                ...
                Route::post('emoji-submit', ['as' => 'user-chat.emoji-submit', 'uses' => 'AdminChatController@postChatEmoji']);
                ...
                Route::get('member-media/{user_id}', ['as' => 'user-chat.member-media', 'uses' => 'AdminChatController@memberMedia']);
                Route::post('chat-status', ['as' => 'user-chat.chat-status', 'uses' => 'AdminChatController@chatStatus']);
                ...
                Route::get('events/show-project/{id}', ['as' => 'events.show-project', 'uses' => 'AdminEventCalendarController@showProject']);
                ...
                Route::resource('task-groups', 'AdminTaskGroupController');
            ...
            Route::group(['middleware' => ['account-setup']], function () {
                ...
                Route::get('billing/invoice_data',  'AdminBillingController@invoiceData')->name('billing.invoice_data');
                Route::get('billing/transactions-data',  'AdminBillingController@transactionsData')->name('billing.transactions_data');
                Route::get('billing/cards-list',  'AdminBillingController@creditCardData')->name('billing.cards_list');
                ...
                Route::get('billing/invoices', 'AdminBillingController@invoices')->name('billing.invoices');
                Route::get('billing/transactions', 'AdminBillingController@transactions')->name('billing.transactions');
                Route::get('billing/payment-settings', 'AdminBillingController@paymentSettings')->name('billing.payment_settings');
                Route::post('billing/payment-settings/save-billing', 'AdminBillingController@updateZohoBilling')->name('billing.payment_settings.save-billing');
                Route::post('billing/payment-settings/save-shipping', 'AdminBillingController@updateZohoShipping')->name('billing.payment_settings.save-shipping');
                ...
                // route redirect from pubbly
                Route::get('billing/pubbly-payment', 'AdminBillingController@pubblyPayment')->name('billing.pubbly-payment');
                // route redirect from zoho
                Route::get('billing/zoho-payment', 'AdminBillingController@zohoPayment')->name('billing.zoho-payment');
                Route::get('billing/zoho-card/{card_id}', 'AdminBillingController@zohoCardDetails')->name('billing.zoho-card');
                Route::post('billing/del-zoho-card', 'AdminBillingController@delZohoCard')->name('billing.del-zoho-card');
            ...
            //Route::get('pagetip/articles/{category}', ['uses' => 'AdminPageTipController@articleCreate'])->name('pagetips.article.create');
            Route::resource('pagetip', 'AdminPageTipController');

            Route::group(
                ['prefix' => 'vehicles'],
                function () {

                    Route::get('create-operator', ['uses' => 'ManageVehiclesController@createOperator'])->name('vehicles.create-operator');
                    Route::post('store-operator', ['uses' => 'ManageVehiclesController@storeOperator'])->name('vehicles.store-operator');
                    Route::post('store-documents', ['uses' => 'ManageVehiclesController@storeDocuments'])->name('vehicles.store-documents');
                    Route::delete('destroy-operator/{id}', ['uses' => 'ManageVehiclesController@destroyOperator'])->name('vehicles.destroy-operator');
                    Route::get('get-operators', ['uses' => 'ManageVehiclesController@getOperators'])->name('vehicles.get-operators');
                    Route::get('edit-operator/{id}', ['uses' => 'ManageVehiclesController@editOperator'])->name('vehicles.edit-operator');
                    Route::post('update-operator/{id}', ['uses' => 'ManageVehiclesController@updateOperator'])->name('vehicles.update-operator');
                    Route::get('download-document/{id}', ['uses' => 'ManageVehiclesController@downloadDocument'])->name('vehicles.download-document');
                    Route::delete('destroy-document/{id?}', ['uses' => 'ManageVehiclesController@destroyDocument'])->name('vehicles.destroy-document');
                });
    ...
    Route::group(
        ...
        Route::post('projects/update-job-status/{id}', ['uses' => 'MemberProjectsController@updateJobStatus'])->name('projects.update-job-status');
        ...
        Route::get('projects/sign/{id}', ['as' => 'projects.sign-modal', 'uses' => 'MemberProjectsController@projectSignModal']);
        Route::post('projects/sign/{id}', ['as' => 'projects.sign', 'uses' => 'MemberProjectsController@projectSign']);
        ...
        Route::get('projects/offline-payment/{id?}', ['uses' => 'MemberProjectsController@offlinePayment'])->name('project.offline-payment');
                        
        Route::post('projects/offline-payment-submit', 'MemberProjectsController@offlinePaymentSubmit')->name('project.offline-payment-submit');
        ...
        Route::post('emoji-submit', ['as' => 'user-chat.emoji-submit', 'uses' => 'MemberChatController@postChatEmoji']);
        Route::get('member-media/{user_id}', ['as' => 'user-chat.member-media', 'uses' => 'MemberChatController@memberMedia']);
        Route::post('chat-status', ['as' => 'user-chat.chat-status', 'uses' => 'MemberChatController@chatStatus']);
        ...
        Route::get('events/show-project/{id}', ['as' => 'events.show-project', 'uses' => 'MemberEventController@showProject']);
    ...
    Route::group(
        ...
        Route::get('invoices/offline-payment/{id?}', ['uses' => 'ClientInvoicesController@offlinePayment'])->name('invoices.offline-payment');
        ...
        Route::get('events/show-project/{id}', ['as' => 'events.show-project', 'uses' => 'ClientEventController@showProject']);
...
Route::group(
    ['prefix' => 'wceo_theme', 'as' => 'client.'], function () {

    Route::get('/datatable', function() { return View::make('test_sample.responsive_datatable', array('pageTitle' => 'TEST...','global'=>'')); });
    Route::get('/dropdown', function() { return View::make('test_sample.dropdown', array('pageTitle' => 'TEST...','global'=>'')); });
    Route::get('/form', function() { return View::make('test_sample.form', array('pageTitle' => 'TEST...','global'=>'')); });
    Route::get('/client_view', function() { return View::make('test_sample.client_view', array('pageTitle' => 'TEST...','global'=>'')); });
    Route::get('/modal', function() { return View::make('test_sample.modal', array('pageTitle' => 'TEST...','global'=>'')); });
